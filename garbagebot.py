...
import random
from garbagebot_config import TOKEN, GUILD, HELG, SCHEDULE, bad_responds, br_size, good_responds, gr_size
...
if __name__ == '__main__':
    courses = ["INF-3200-1", "INF-3201-1", "FYS-2021", "INF-2200-1", "INF-2700-1"]
